...
class Ngram:
    ...
    def train_sentiment(self, df_train, df_test):
        ...
        train_corpus_embedding = [[0 for i in range(feature_num)] for i in range(len(df_train['review']))]
        test_corpus_embedding = [[0 for i in range(feature_num)] for i in range(len(df_test['review']))]
